...
echo "====================VIVEK LOGGING THE VALUES=========================="
echo "AZUREUSER is $AZUREUSER"
echo "PASSWD is $PASSWD"
echo "PASSPHRASE is $PASSPHRASE"
echo "ARTIFACTS_URL_PREFIX is $ARTIFACTS_URL_PREFIX"
echo "NETWORK_ID is $NETWORK_ID"
echo "MAX_PEERS is $MAX_PEERS"
...
echo "CAKESHOP_FQDN is $CAKESHOP_FQDN"
echo "CAKESHOP_STARTING_PORT is $CAKESHOP_STARTING_PORT"
echo "====================VIVEK LOGGING THE VALUES=========================="
############
# Constants
############
